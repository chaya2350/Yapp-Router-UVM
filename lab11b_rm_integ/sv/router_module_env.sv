...
class router_module_env extends uvm_env;
 ...
 function void build_phase(uvm_phase phase);
    ...
    sb  = router_scoreboard_fifo::type_id::create("sb",  this);
 ...
 function void connect_phase(uvm_phase phase);
    ...
    reference.valid_yapp_port.connect(sb.yapp_fifo.analysis_export);
  ...
  // === Lab 9D
    yapp_export.connect(sb.yapp_fifo.analysis_export);
    hbus_export.connect(sb.hbus_fifo.analysis_export);
    chan0_export.connect(sb.ch_fifo[0].analysis_export);
    chan1_export.connect(sb.ch_fifo[1].analysis_export);
    chan2_export.connect(sb.ch_fifo[2].analysis_export);
